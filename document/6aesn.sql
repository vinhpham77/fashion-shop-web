...
(1, '<p>Sơ mi nam tay ngắn<br>Trên nền vải denim được đánh bạc màu giả<br>Phía trước có túi ngực<br>Ống tay gập gấu khoảng 2-3cm<br>Khuy cài cùng màu với nền vải.</p><br><p>Thiết kế sơ mi denim mang đến vẻ năng động và trẻ trung<br>Sắc đen ngả bạc giúp vẻ ngoài của các chàng trai thêm phần phong trần, mạnh mẽ<br>Thiết kế chú trọng vào <br>tính cơ bản nên phù hợp để chàng diện vào nhiều dịp khác nhau.</p>', 'Cổ Áo: cổ đức<br>Tay Áo: tay cộc<br>Kiểu Áo: Regular fit<br>Độ dài: dài thường<br>Họa Tiết: trơn', '* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.'),
(2, '<p>Áo sơ mi cổ đức, tay ngắn<br>Cài bằng hàng khuy phía trước<br>Dáng regular kết hợp với chất liệu lụa cao cấp giúp bạn mặc thoải mái và dễ chịu<br>MIx cùng quần jeans màu đen, sooc để có set đồ ăn ý nhất nhé!</p>', 'Cổ Áo: khác<br>Tay Áo: tay ngắn<br>Kiểu Áo: Regular<br>Độ dài: dài thường<br>Họa Tiết: in hình', '* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.'),
(3, '<p>Áo sơ mi dáng slim fit với cổ đức và ống tay dài<br>Họa tiết kẻ mờ<br>Độ dài vừa phải<br>Có viền ngoài để giấu khuy cài.</p><br><p>Những chiếc áo sơ mi kẻ luôn được lòng các quý ông công sở<br>Thiết kế chú trọng đến sự tối giản sẽ tôn lên vẻ ngoài phong độ, chỉn chu của người mặc<br>Dáng slim fit ôm nhẹ phù hợp để bạn mặc khi diện vest và quần Âu.', 'Cổ Áo: cổ đức<br>Tay Áo: tay dài<br>Kiểu Áo: Slim fit<br>Độ dài: dài thường<br>Họa Tiết: kẻ', '* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.'),
(4, '<p>Áo sơ mi cổ đức phối màu hình tam giác<br>Tay dài bo gấu và 2 khuy cài đính kèm<br>Vạt áo hình phía trước<br>Cài bằng hàng khuy ẩn tà phía trước.</p><br><p>Kiểu dáng Slim fit thiết kế form ôm nhẹ, tôn đường nét của cơ thể<br>Tông màu lịch lãm, dễ phối nhiều trang phục như quần jean, short, quần tây..<br>Áo có thể sơ vin hoặc thả suông nhờ tà lượn thời trang.</p>', 'Cổ Áo: cổ đức<br>Tay Áo: tay dài<br>Kiểu Áo: Slim fit<br>Độ dài: dài thường, Oversize<br>Họa Tiết: trơn', '* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.'),
(5, '<p>Áo sơ mi cổ đức<br>Tay dài bo gấu và 2 khuy cài đính kèm<br>1 túi vuông trước ngực<br>Cài bằng hàng khuy phía trước<br>Vải họa tiết tinh tế.</p><br><p>Kiểu dáng Slim fit thiết kế form ôm nhẹ, tôn đường nét của cơ thể<br>Tông màu lịch lãm, dễ phối nhiều trang phục như quần jean, short, quần tây..<br>Áo có thể sơ vin hoặc thả suông nhờ tà lượn thời trang.</p>', 'Cổ Áo: cổ đức<br>Tay Áo: tay dài<br>Kiểu Áo: Slim fit<br>Độ dài: dài thường<br>Họa Tiết: khác', '* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.'),
(6, '<p>Zuýp chữ A 2 lớp dáng trên gối<br>Có 1 móc kim loại tạo kiểu phía trước<br>2 viền túi giả 2 bên<br>Cài bằng khóa ẩn sau lưng.</p><br><p>gợi ý cho bạn cứ mix theo combo ton-sur-ton với áo vest đồng bộ MS 67M7<br>76 sẽ có vẻ ngoài trông thật sành điệu, tự tin ghi điểm tuyệt đối trong mắt người đối diện<br>Muốn làm mới phong cách thời trang công sở của mình, nhất định phải có ít nhất một kiểu chân váy như thế này trong tủ đồ của mình nhé!</p>', 'Kiểu dáng: chữ A<br>Độ dài: trên gối<br>Chất liệu: Tuysi', '* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.'),
(7, '<p>Zuýp chữ A 2 lớp<br>Mặt trước dưới gấu thêu chữ và đính hoa nổi khác màu tạo nổi bật<br>Cài bằng khóa kéo ẩn sau lưng.</p><br><p>Với chiều dài trên gối cùng chất liệu Tuysi cao cấp giúp nàng trở nên trẻ trung và năng động hơn<br>Mix cùng áo blazer, áo sơ mi kiểu, áo thun basic là bạn có thể tự tin bước ra ngoài rồi!</p>', 'Kiểu dáng: chữ A<br>Độ dài: trên gối<br>Họa tiết: trơn<br>Chất liệu: Tuysi', '* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.'),
(8, '<p>Zuýp chữ A  2 lớp<br>Mặt trước có hàng khuy bọc vải kiểu chéo trang trí<br>Xẻ tạo kiểu dưới gấu<br></p><br><p>Chất liệu Tuysi không quá dày cũng không quá mỏng tạo form dáng cứng cáp, không xù lông đặc biệt không nhăn, dễ dàng tạo sự thoải mái, không gò bó và mang đến nét đẹp năng động, trẻ trung cho người mặc<br>Chân váy chữ A công sở cũng ghi điểm nhờ sự “thân thiện” có thể kết hợp cùng áo sơ mi, áo thun… đầy ấn tượng.</p>', 'Kiểu dáng: chữ A<br>Độ dài: trên gối<br>Họa tiết: trơn<br>Chất liệu: Tuysi', '* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.'),
(9, '<p>Zuýp chữ A 2 lớp cạp có đai liền và đỉa ở giữa<br>Phom chữ A basic<br>Trang trí bằng các đường chần chỉ nổi màu trắng tạo điểm nhấn.</p><br><p>Sử dụng chất vải Tuysi  bên trong có lớp lót dính liền tạo cho nàng cảm giác thoải mái khi diện thiết kế này<br>Dáng chữ A dễ phối hợp với nhiều kiểu áo, và phụ kiện giúp nàng trở nên năng động và tự tin hơn.</p>', 'Kiểu dáng: chữ A<br>Độ dài: trên gối<br>Họa tiết: trơn<br>Chất liệu: Tuysi', '* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.'),
(10, '<p>Zuýp chữ A dáng dài ngang bắp<br>Cạp cao<br>Mặt trước trang trí hàng khuy làm điểm nhấn<br>Cài bằng khóa kéo ẩn phía sau<br>Có thể mix cùng áo croptop đồng bộ.</p><br><p>Chất liệu vải Thô xước mang lại cảm giác thoáng mát, thoải mái cho người mặc bởi khả năng hút ẩm cao, thấm hút tốt.</p>', 'Kiểu dáng: chữ A<br>Độ dài: ngang bắp<br>Họa tiết: trơn<br>Chất liệu: thô', '* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.'),
...
(96, '<p>Đầm maxi cổ yếm thắt dây nơ phía trước<br>Tay sát nách<br>Eo có đỉa kèm đai rời đi kèm<br>Tùng váy suông kiểu xòe nhẹ, xẻ 2 bên<br>Bên trong có lớp lót rời<br>Vải họa tiết bắt mắt.</p><br> <p>Được may bằng chất liệu lụa với đặc tính mềm mại, thoáng mát, kết hợp với họa tiết hoa xinh xắn, đây sẽ là lựa chọn tuyệt vời dành cho nàng vào mùa hè này<br>Chiếc đầm có lớp lót trong tinh tế, cổ yếm điệu đà, cùng với gam màu tươi sáng đem lại sự tươi trẻ, nữ tính và nổi bật cho nàng thơ.</p>', 'Cổ áo: cổ khác<br> Tay áo: không tay<br> Kiểu dáng: Maxi<br> Độ dài: ngang mắt cá<br> Hoạ tiết: hoa<br> Chất liệu: lụa', '<p>* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.</p>'),
(97, '<p>Đầm dáng maxi với độ dài ngang bắp chân<br>Thiết kế thân trên ôm nhẹ, thân dưới xòe rộng tự nhiên<br>Đầm không có tay áo, thay vào đó là 2 dây đai to bản nối đến phần vặn xoắn trước ngực<br>Eo đầm được nhấn cao nhẹ nhàng<br>Phần dưới vạt được nhấn xòe.</p><br> <br><p>Thiết kế tràn ngập hương sắc mùa hè này sẽ là sự lựa chọn hoàn hảo cho chuyến du lịch của nàng<br>Đường nét của thiết kế hướng đến sự tối giản nhưng không làm mất đi vẻ cuốn hút nơi diện mạo nàng<br>Ngược lại, những đường nét đơn giản nhưng thú vị này sẽ khiến mọi cô nàng sở hữu một loại khí chất đặc biệt, rực rỡ và lung linh như những tia nắng ngày hè.</p>', 'Cổ áo: cổ khác<br> Tay áo: không tay<br> Kiểu dáng: Maxi<br> Độ dài: ngang bắp<br> Hoạ tiết: Trơn<br> Chất liệu: Thô', '<p>* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.</p>'),
(98, '<p>Đầm cổ tim, dáng không tay<br>Eo chiết<br>Có hàng khuy bọc vải phía trước<br>Tùng váy dài ngang bắp, xẻ gấu phía trước<br>Cài bằng khóa kéo ẩn sau lưng.</p><br> <br><p>Chất liệu vải lụa (có lớp lót liền bên trong) mềm mịn, co dãn nhẹ, mặc cực thoải mái, lên form dáng cực chuẩn !</p>', 'Cổ áo: cổ tim<br> Tay áo: không tay<br> Kiểu áo: Đầm xoè<br> Độ dài: ngang bắp<br> Hoạ tiết: Trơn<br> Chất liệu: lụa, Tuysi', '<p>* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.</p>'),
(99, '<p>Đầm maxi cổ V, dáng không tay viền bèo<br>Hàng khuy bọc vải trang trí phía trước<br>Eo chiết nhẹ<br>Tùng dài ngang mắt cá, xếp layer xòe<br>Cài bằng khóa kéo ẩn bên sườn.</p><br> <br><p>Đầm maxi cổ V, dáng không tay viền bèo<br>Hàng khuy bọc vải trang trí phía trước<br>Eo chiết nhẹ<br>Tùng dài ngang mắt cá, xếp layer xòe<br>Cài bằng khóa kéo ẩn bên sườn.</p>', 'Cổ áo: cổ chữ V<br> Tay áo: không tay<br> Kiểu áo: Maxi<br> Độ dài: ngang mắt cá<br> Hoạ tiết: Trơn<br> Chất liệu: thô', '<p>* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.</p>'),
(100, '<p>Đầm maxi họa tiết hoa<br>Vai bo chun co giãn mặc kiểu trễ<br>Tay áo ngắn<br>Eo chiết bo bằng chun co giãn<br>Tùng váy xếp lớp tạo xòe<br>Cài bằng khóa kéo ẩn phía sau<br>Chiffon kết hợp lụa nhẹ nhàng, bay bổng<br>Vải họa tiết bắt mắt.</p><br> <br><p>Sự pha trộn màu sắc hài hòa cùng đường nét sắc sảo, họa tiết mềm mại không chỉ thể hiện được phong cách riêng, mà còn mang lại sự trẻ trung, hứng khởi cho người mặc<br>Mix thêm chút phụ kiện bạn có thể tự tin ra đường<br>Với nhiều phiên bản màu đơn sắc bạn có thể dễ dàng lựa chọn và làm phong phú tủ đồ của mình.</p>', 'Cổ áo: cổ chữ V<br> Tay áo: tay ngắn<br> Kiểu áo: Maxi<br> Độ dài: ngang mắt cá<br> Hoạ tiết: hoa<br> Chất liệu: chiffon', '<p>* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.</p>'),
(101, '<p>Đầm thun dáng ôm, độ dài qua gối<br>Thiết kế trên nền vải trơn và chất liệu thun<br>Cổ dáng trái tim, tay dài<br>Phần vạt xẻ đằng trước<br>Đằng sau có khóa kéo trùng màu.</p><br> <br><p>Một chiếc đầm thun sẽ giúp nàng thoải mái khi diện cả ngày dài<br>Dù sở hữu chất liệu thun nhưng chiếc đầm này vẫn rất đứng dáng, không nhăn, không mất form dù nàng có di chuyển nhiều<br>Thiết kế cổ tim thu hút khéo kéo khoe ra đường xương quai xanh mảnh mai của nàng<br>Chân váy được may cắt theo dáng hoa tulip trang nhã phối cùng đường xẻ phóng khoáng và quyến rũ.</p>', 'Cổ áo: cổ khác<br> Tay áo: tay dài<br> Kiểu dáng: đầm ôm<br> Độ dài: qua gối<br> Hoạ tiết: trơn<br> Chất liệu: thun', '<p>* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.</p>'),
(102, '<p>Đầm thun cổ tròn, tay ngắn<br>Bo chun co giãn ở cổ áo và tay<br>In hình và chữ, đính hoa nổi khác màu phía trước tạo điểm nhấn<br>Độ dài qua gấu, xẻ 2 bên sườn.</p><br> <br><p>Vải thun có tính chất làm mát, thấm hút mồ hôi tốt nên được sử dụng nhiều vào mùa nóng, mang lại cảm giấc rất thoải mái, dễ chịu và mát mẻ, làm dịu đi nhiều cái nóng mùa hè<br>Kiểu dáng basic dễ phối đồ nhưng vẫn không kém phần nổi bật.</p>', 'Cổ áo: cổ tròn<br> Tay áo: tay ngắn<br> Kiểu dáng: suông<br> Độ dài: qua gối<br> Hoạ tiết: trơn<br> Chất liệu: thun', '<p>* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.</p>'),
(103, '<p>Đầm thun lệch vai 1 bên -  vải kiểu xếp nếp<br>Eo chiết<br>Tùng dài qua gối<br>Cài bằng khóa kéo ẩn sau lưng.</p><br> <br><p>Mẫu đầm công sở được triển khai trên nền chất liệu thun, dày dặn cùng màu đen đầy sự sang trọng và quyến rũ<br>Diện item này nàng phối thêm một đôi giày cao gót là có thể tự tin đến sở làm, hoặc thêm một chiếc clutch ánh kim là đã sang trọng ở những buổi tiệc rồi đấy.</p>', 'Cổ áo: cổ tròn<br> Tay áo: tay ngắn<br> Kiểu dáng: suông<br> Độ dài: qua gối<br> Hoạ tiết: trơn<br> Chất liệu: thun', '<p>* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.</p>'),
(104, '<p>Đầm thun cổ lọ có dây kéo khóa kim loại<br>Tay áo dài bo thun gân co giãn tạo bồng<br>Dáng đầm suông<br>Thêu chữ 1 bên ngực<br></p><br> <br><p>Chất liệu thun mềm mại giúp lên form chuẩn cùng độ co giãn nhẹ tạo cảm giác năng động, thoải mái cho người mặc.</p>', 'Cổ áo: cổ lọ<br> Tay áo: tay dài<br> Kiểu dáng: suông<br> Độ dài: trên gối<br> Hoạ tiết: trơn<br> Chất liệu: thun', '<p>* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.</p>'),
(105, '<p>Đầm thun cổ cut-out có xoắn nút cách điệu<br>Tay lỡ<br>Dáng đầm ôm, eo chiết<br>Tùng dài qua gối<br>Cài bằng khóa kéo ẩn phía sau.</p><br> <br><p>Vải thun mềm mịn êm ái và thân thiện với làn da<br>Một chút khéo léo trong khâu mix & match cùng phụ kiện chiếc đầm sẽ giúp bạn trở nên duyên dáng hơn, xinh đẹp hơn trong mắt mọi người.</p>', 'Cổ áo: cổ cách điệu<br> Tay áo: tay lỡ<br> Kiểu dáng: đầm ôm<br> Độ dài: qua gối<br> Hoạ tiết: trơn<br> Chất liệu: thun', '<p>* Vải dệt kim : sau khi giặt sản phẩm phải được phơi ngang tránh bai dãn.</p>');
